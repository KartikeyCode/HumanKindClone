...
export default function Hero(){
    return(
        <div className="bg-white mt-20 flex flex-col">
            ...
            <Image className="absolute top-52 w-11/12" src={hero2}></Image>
            </div>
            ...
            <button className="bg-white rounded-full h-14 self-center text-black px-6 f2  group-hover:">Get a Lunchbox</button>
                </div>
            <div className="flex bg-black rounded-full h-16 self-center pr-[2px] pl-[4px] group hover:scale-105 hover:pb-1 cursor-pointer mx-1">
            <button className="bg-black rounded-full h-14 self-center text-white px-6 f2  group-hover:bg-red-600">Burn a Lunchbox</button>
            </div>
            </div>
